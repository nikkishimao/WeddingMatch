...
Along with Tessa Murphy, Gina Kuszajewski, and Elana Savita Alphonso, we match couples with vendors and venues to plan their perfect wedding, and give vendors and venues the opportunity to make their services, prices, and availability known to prospective clients. This wedding planner database will allow parties involved in the planned process (Vendors, Clients) to access relevant information in real-time. This allows for a more seamless experience on both ends, and should allow vendors to increase their business by reaching out to couples. Couples can query the system to find out which vendors are available in specific locations on a given date, and/or whether a vendor is willing to travel to their preferred location.
